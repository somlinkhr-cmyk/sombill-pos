...
-- 006: Functions
-- ============================================================================
-- This migration creates all PostgreSQL functions for the database.
--
-- Dependencies: 003_tables.sql (tables must exist)
...
-- ============================================================================
-- NOTE: This function is deprecated. User creation should be done via Supabase Auth SDK.
...
DECLARE
  ...
  v_result JSONB;
BEGIN
  -- DEPRECATED: Direct auth.users insertion is not recommended
  -- Use Supabase Auth SDK on the frontend to create users
  -- This function now returns an error
  RAISE EXCEPTION 'DEPRECATED: Use Supabase Auth SDK to create users. Direct auth.users insertion is not supported.';
END;
$$;
